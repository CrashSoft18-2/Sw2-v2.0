...
function addLineSeminario(){
   document.getElementById("taskSeminario").value = "add";
   document.getElementById("add").style.display = "none";
   
   var tbody = document.getElementById("detalle").firstChild.nextSibling;
   
   var nodeTopic = document.createElement("input");
   ...
   save.setAttribute("class", "save");
   save.setAttribute("src", "data:image/png;base64,");
   save.setAttribute("onclick", "submitSeminario()");
   cancel.setAttribute("class", "cancel");
   cancel.setAttribute("src", "https://techflourish.com/images/cross-with-sunset-clipart-16.png");
   cancel.setAttribute("onclick", "cancelSeminario()");
   
   nodeTopic.setAttribute("class", "row");
   ...
   nodeTopic.setAttribute("id", "topic");
   ...
   cell1.appendChild(nodeTopic);
   cell2.appendChild(nodeFecha);
   cell3.appendChild(nodeHora);
   cell4.appendChild(nodeLugar);
...
function deleteRowHistorial(id){
  document.getElementById("taskAsesoria").value = "delete";
  submitHistorial(id);
}

function deleteRowSeminario(id){
  document.getElementById("taskSeminario").value = "delete";
  submitSeminario(id);
}
